...
class LicenseService {
  ...
  Future<void> _initializeFirestoreCollections() async {
    try {
      // Create sample license document
      ...
      // Create sample request document
      ...
      debugPrint('Firestore collections initialization: $e');
    }
  }
  ...
  Future<String> generateLicenseKey({
    ...
    try {
      ...
      throw LicenseException('License generation failed');
    }
  }
  ...
  Future<void> requestNewLicense({
    ...
    try {
      ...
      throw LicenseException('License request failed');
    }
  }
